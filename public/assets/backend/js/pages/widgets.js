...
var KTWidgets = function() {
    // Private properties
    function getValProgress() {
        return $.ajax({
            "url": "transaction/total-progress",
            "type": "GET"
        });
    }
    ...
    function getValDone() {
        return $.ajax({
            "url": "transaction/total-done",
            "type": "GET"
        });
    }

    async function arrayProgress() {
        var x = await getValProgress();
        return x;
    }

    async function arrayDone() {
        var x = await getValDone();
        return x;
    }
    let arrDone = arrayDone();
    let arrProgress = arrayProgress();
