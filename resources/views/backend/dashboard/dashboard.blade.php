                ...
                <div class="card-body p-0">
                    <div class="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
                        ...
                        <div class="d-flex flex-column text-right">
                            <span class="text-dark-75 font-weight-bolder font-size-h3">{{ count($data['progress']) }}</span>
                            <span class="text-muted font-weight-bold mt-2">Total progress Orders</span>
                        </div>
                    </div>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-body p-0">
                    <div class="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
                        ...
                        <div class="d-flex flex-column text-right">
                            <span class="text-dark-75 font-weight-bolder font-size-h3">{{ count($data['done']) }}</span>
                            <span class="text-muted font-weight-bold mt-2">Total done Orders</span>
                        </div>
                    </div>
